...
**Snabblänkar:**
- Android build-workflow: <https://github.com/johkahultsfred-cmd/PanikknappenV2/actions/workflows/android-build.yml>
- Android senaste körningar: <https://github.com/johkahultsfred-cmd/PanikknappenV2/actions/workflows/android-build.yml?query=event%3Apush>
